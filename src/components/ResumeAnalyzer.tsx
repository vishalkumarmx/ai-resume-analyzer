  ...
  return(<div className="min-h-screen w-full">
    <header className="sticky top-0 z-10 backdrop-blur bg-white/70 border-b">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3"><div className="h-9 w-9 rounded-xl bg-indigo-600"/><div><p className="text-sm text-gray-500">AI-Powered</p><h1 className="font-bold tracking-tight text-xl">Resume Analyzer</h1></div></div>
